...
// Base URL for the TeaStore web UI
const BASE_URL = 'http://localhost:8080/tools.descartes.teastore.webui'; // ← Change this as needed
...
export default function () {
    ...
    check(removeExtraRes, { 'remove item 302': (r) => r.status === 302 });
    ...
    check(proceedCheckoutRes, { 'checkout 302': (r) => r.status === 302 });
