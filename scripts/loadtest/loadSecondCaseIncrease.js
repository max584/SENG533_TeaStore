...
// Easily update this to run the test against different environments
const BASE_URL = 'http://localhost:8080/tools.descartes.teastore.webui';

export let options = {
    stages: [
        { duration: '120s', target: 20 },
        { duration: '240s', target: 20 },
...
export default function () {
    ...
    check(removeExtraUpdateCartRes, { 'remove product 302': (r) => r.status === 302 });
    ...
    check(proceedPurchaseCartRes, { 'proceed checkout 302': (r) => r.status === 302 });
